# [notes/homewok] The Data Engineering Handbook 📓👨🏾‍💻⚙️
This repository is a fork of the original Engineering Handbook [[Link]](https://github.com/DataExpert-io/data-engineer-handbook/tree/main). It contains notes and projects related to the 6-week intensive Data Engineer Bootcamp from [DataExpert.io Community Academy](https://learn.dataexpert.io/).


### <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxoRNdFEOyEA1DuG_oqP_6MDCMtUKlfgmreSzxH-0vceiHb34OSNlFcnt6yyeZ-DDpHW0&usqp=CAU" width="30" height="30" style="vertical-align: middle;"> Structure of Git branches:

```
├── main            <- Principal branch with the latest changes from the original repossitory.
│
├────── develop          <- Branch with homeworks and changes made during the bootcamp.
        |
        |────── feature/week_1          <- Branch with the changes made in week 1.
        |
        |────── feature/week_2          <- Branch with the changes made in week 2.
        |
        :
        :
```
